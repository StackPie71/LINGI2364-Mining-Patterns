...
class FindingKBestSubgraphs(PatternGraphs):
    ...
    # Stores any pattern found that has not been pruned
    # Should only stores the set of k-best patterns
    def store(self, dfs_code, gid_subsets):
        ...
        pos_conf = pos_conf * 1000 + tot_support  # To manage with the total support
...
def point1():
    # args = sys.argv
    database_file_name_pos = "data/molecules-small.pos" # args[1]  # First parameter: path to positive class file
    database_file_name_neg = "data/molecules-small.neg" # args[2]  # Second parameter: path to negative class file
    k = 5 # int(args[3])  # Third parameter: k
    minsup = 5 # int(args[4])  # Fourth parameter: minimum support
...
## POINT 1 : python main3.py data/molecules-small.pos data/molecules-small.neg 5 5
