...
def train_and_evaluate(minsup, k, database, subsets):
	...
	#accuracy = cross_val_score(classifier, train_fm, train_labels)
...
def point2() :
	...
	# Otherwise: performs k-fold cross-validation:
		...
		for i in range(nfolds):
			...
			all_acc.append(train_and_evaluate(minsup, k, graph_database, subsets))
		print(all_acc)
...
## POINT 2 : python q2.py data/molecules-small.pos data/molecules-small.neg 5 5 4
# python q2.py data/molecules-medium.pos data/molecules-medium.neg 5 5 4